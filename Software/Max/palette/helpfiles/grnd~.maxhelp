...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 9.0, 415.0, 553.0, 20.0 ],
					"text" : "A ground at -0.01 m puts force on the firefader when it is more than 1 cm above its center"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 139.0, 368.0, 127.0, 27.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 296.0, 368.0, 224.0, 33.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 436.0, 59.0, 224.0, 33.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 9.0, 370.0, 118.0, 27.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 51.0, 60.0, 118.0, 27.0 ],
					"text" : "grnd~ g -0.01"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 9.0, 247.5, 94.0, 27.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 118.0, 229.0, 160.0, 51.0 ],
					"text" : "Arguments:\nname (text)\nlocation in meters (float)"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 178.0, 59.0, 98.0, 100.0 ],
					"text" : "For mass-like objects:\n• Inlets are force inputs\n• Outlets are position outputs",
					"textcolor" : [ 0.863842, 0.044178, 0.282839, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 264.0, 108.5, 184.0, 92.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"text" : "grnd~ creates an immobile ground point at a specified location",
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 18.5, 405.0, 107.0, 405.0, 129.0, 362.0, 148.5, 362.0 ],
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 148.5, 405.0, 130.0, 405.0, 107.0, 362.0, 18.5, 362.0 ],
					"source" : [ "obj-17", 0 ]
				}

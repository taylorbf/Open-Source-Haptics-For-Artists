...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 20.0, 404.0, 629.0, 20.0 ],
					"text" : "This touch link has an offset of 0.01 (1 cm), so force will only be felt on the fader after it closes the 1 cm offset gap"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 15.0, 225.0, 190.0, 27.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 166.0, 43.0, 169.0, 47.0 ],
					"text" : "touch~ c 300. 1.5 0.01"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 250.0, 623.0, 185.0, 67.0 ],
					"presentation" : 1,
					"presentation_linecount" : 5,
					"presentation_rect" : [ 709.0, 364.0, 128.0, 107.0 ],
					"text" : "c has a stiffness of 300, damping of 1.5, and offset of 0."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 28.0, 589.5, 471.0, 116.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 59.0, 461.5, 91.0, 47.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 15.0, 463.5, 45.0, 45.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 145.0, 358.0, 190.0, 27.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 151.0, 28.0, 169.0, 47.0 ],
					"text" : "touch~ c 300. 1.5 0.01"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 375.0, 358.0, 225.0, 36.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 406.0, 29.0, 225.0, 36.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 15.0, 360.0, 94.0, 27.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 21.0, 30.0, 94.0, 27.0 ],
					"text" : "grnd~ g 0."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 214.0, 201.0, 150.0, 78.0 ],
					"text" : "Arguments:\nname (text)\nstiffness (float)\ndamping (float)\noffset (float)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 9.0, 116.0, 216.0, 47.0 ],
					"presentation" : 1,
					"presentation_linecount" : 6,
					"presentation_rect" : [ 178.0, 59.0, 98.0, 87.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 9.0, 80.0, 439.0, 36.0 ],
					"text" : "A contact (touch) link is like a spring with an offset gap in it, so the force is only active if the offset gap is pushed closed.",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 9.0, 20.0, 216.0, 60.0 ],
					"text" : "touch~"
				}
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 24.5, 391.0, 113.0, 391.0, 135.0, 352.0, 154.5, 352.0 ],
					"source" : [ "obj-13", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 154.5, 391.0, 136.0, 391.0, 113.0, 352.0, 24.5, 352.0 ],
					"source" : [ "obj-17", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 325.5, 389.0, 336.0, 389.0, 354.0, 350.0, 384.5, 350.0 ],
					"source" : [ "obj-17", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 384.5, 389.0, 358.0, 389.0, 332.0, 350.0, 324.0, 350.0, 325.5, 350.0 ],
					"source" : [ "obj-5", 0 ]
				}
